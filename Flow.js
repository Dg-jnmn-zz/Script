...
async function fetchInfo(sub) {
    ...
    $.http.get({
        ...
        if (!userinfo) {
            $.notify(`🚀 [ ${sub.name}机场]`, `❌ 机场：${sub.name} 未提供流量信息！`);
        }
